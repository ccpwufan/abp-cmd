...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 10d9e55d-4281-42cd-9d91-8e31e785d1f3
```

> `10d9e55d-4281-42cd-9d91-8e31e785d1f3` is the password of the certificate, you can change it to any password you want.
...
The application needs a database. Run the following command in the `AbpCMD` directory to migrate the database and seed the initial data. This step is automatically done when you create a new solution, if you didn't especially disabled it.
